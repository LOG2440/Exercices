...
- l'accès à une variable de classe privée `#x` va générer une erreur et non retourner `undefined` comme l'exemple plus haut. Le résultat de certaines commandes sera légèrement différent.
